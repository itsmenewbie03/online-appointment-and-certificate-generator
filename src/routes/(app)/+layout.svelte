<nav class="fixed top-0 z-50 w-full bg-white border-b border-gray-200 dark:bg-green-500 dark:border-green-600">
      ...
      <div class="flex items-center justify-between">
        <div class="flex items-center justify-start">
          ...
          <a href="/home" class="flex ml-2 md:mr-24">
            <img src="/src/lib/assets/BRGY.-BANGCU1D-150x150.png" class="h-12 mr-4" alt="FlowBite Logo" />
            <span class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">This should be the current page</span>
          </a>
        </div>
  ...
  <aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0" aria-label="Sidebar">
   <div class="h-full px-3 pb-4 overflow-y-auto bg-white">
     <ul class="space-y-2 font-medium">
       <li>
         <a href="/home" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-green-200">
       ...
       <li>
         <a href="#" class="flex items-cflex items-center p-2 text-gray-900 rounded-lg hover:bg-green-200">
           <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 group-hover:text-gray-900" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 18">
             <path d="M6.143 0H1.857A1.857 1.857 0 0 0 0 1.857v4.286C0 7.169.831 8.831 1.857 8.857h4.286A1.857 1.857 0 0 0 8 7.143V1.857A1.857 1.857 0 0 0 6.143 0Z" />
             <path d="M16 0h-4.286A1.857 1.857 0 0 0 10 1.857v4.286C10 7.169 10.831 8.831 11.857 8.857h4.286A1.857 1.857 0 0 0 18 7.143V1.857A1.857 1.857 0 0 0 16.143 0Z" />
           </svg>
       ...
       <li>
         <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-green-200">
       ...
       <li>
         <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-green-200">
           <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 20">
             ...
             <path d="M7 9a1 1 0 0 1-2 0V7h2v2Zm0-5a2 2 0 1 1 4 0v1H7V4Zm6 5a1 1 0 1 1-2 0V7h2v2Z" />
           </svg>
           <span class="flex-1 ml-3 whitespace-nowrap">Placeholder</span>
         </a>
       </li>
       <li>
         <a href="/create" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-green-200">
       ...
       <li>
         <a href="/resident-db" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-green-200">
           <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
